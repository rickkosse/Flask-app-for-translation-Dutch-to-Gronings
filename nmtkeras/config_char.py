...
def load_parameters():
    ...
    SRC_LAN = 'nl'                                  # Language of the source text.
    TRG_LAN = 'gro'                                  # Language of the target text.
    ...
    STORE_PATH = 'trained_models_char/' + MODEL_NAME + '/'  # Models and evaluation results will be stored here.
    DATASET_STORE_PATH = 'datasets/char/'                   # Dataset instance will be stored here.

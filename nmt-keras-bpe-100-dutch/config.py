...
def load_parameters():
    ...
    SRC_LAN = 'gro'                                  # Language of the source text.
    TRG_LAN = 'nl'                                  # Language of the target text.
    ...
    ATTENTION_MODE = 'scaled-dot'                 # Attention mode. 'add' (Bahdanau-style), 'dot' (Luong-style) or 'scaled-dot'.
